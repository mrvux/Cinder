...
public:
	...
	static D3D11_INPUT_ELEMENT_DESC Color3(int slot = 0, int index = 0);
	static D3D11_INPUT_ELEMENT_DESC Color4(int slot = 0, int index = 0);

	static D3D11_INPUT_ELEMENT_DESC TexCoord2(int slot = 0,int index = 0);
	static D3D11_INPUT_ELEMENT_DESC TexCoord3(int slot = 0,int index = 0);
	static D3D11_INPUT_ELEMENT_DESC TexCoord4(int slot = 0,int index = 0);
};
