...
D3D11_INPUT_ELEMENT_DESC VertexElements::Color3(int slot,int index)
{
	D3D11_INPUT_ELEMENT_DESC elem;
	elem.AlignedByteOffset = 0;
	elem.Format = DXGI_FORMAT::DXGI_FORMAT_R32G32B32_FLOAT;
...
D3D11_INPUT_ELEMENT_DESC VertexElements::Color4(int slot,int index)
{
	D3D11_INPUT_ELEMENT_DESC elem;
	elem.AlignedByteOffset = 0;
	elem.Format = DXGI_FORMAT::DXGI_FORMAT_R32G32B32A32_FLOAT;
...
D3D11_INPUT_ELEMENT_DESC VertexElements::TexCoord3(int slot,int index)
{
	D3D11_INPUT_ELEMENT_DESC elem;
	elem.AlignedByteOffset = 0;
	elem.Format = DXGI_FORMAT::DXGI_FORMAT_R32G32B32_FLOAT;
...
D3D11_INPUT_ELEMENT_DESC VertexElements::TexCoord4(int slot,int index)
{
	D3D11_INPUT_ELEMENT_DESC elem;
	elem.AlignedByteOffset = 0;
	elem.Format = DXGI_FORMAT::DXGI_FORMAT_R32G32B32A32_FLOAT;
